...
module.exports = {
  ...
  */
  csrf: {
    ...
    filterUris: ['/dashboard/users/login', '/dashboard/users/register', '/dashboard/users/create', '/dashboard/users/edit/:id', '/dashboard/roles/edit/:id', '/dashboard/roles/create', '/dashboard/articles/create', '/dashboard/articles/edit/:id'],
    cookieOptions: {
      httpOnly: false,
      sameSite: true,
      path: '/',
